(function() {
    ...
    editor.addEventListener('keyup', decode, false);
    editor.addEventListener('click', decode, false);
    var result = document.getElementById('result');
    result.addEventListener('keyup', encode, false);
    result.addEventListener('click', encode, false);

    function encode(e) {
        editor.value = LZString.compressToEncodedURIComponent(result.value);
    }

    function decode(e) {
        result.value = LZString.decompressFromEncodedURIComponent(editor.value);
    }
